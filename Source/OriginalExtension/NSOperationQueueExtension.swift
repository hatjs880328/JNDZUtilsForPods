...
class NSOperationQueueExtension: OperationQueue {
     ...
     */
    func addOperation(_ op: Operation, operationType:NSOperationType, queueACC:Operation.QueuePriority) {
